...
type ApronServiceRequest struct {
	...
	RespStream string `protobuf:"bytes,2,opt,name=resp_stream,json=respStream,proto3" json:"resp_stream,omitempty"`
	// raw request data, serialized from fasthttp request
	RawRequest []byte `protobuf:"bytes,4,opt,name=raw_request,json=rawRequest,proto3" json:"raw_request,omitempty"`
}
...
func (x *ApronServiceRequest) GetRespStream() string {
	if x != nil {
		return x.RespStream
	}
	return ""
...
var file_models_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x50, 0x61, 0x74, 0x68, 0x22, 0x76, 0x0a, 0x13, 0x41, 0x70, 0x72, 0x6f, 0x6e, 0x53,
	...
	0x72, 0x65, 0x73, 0x70, 0x5f, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0a, 0x72, 0x65, 0x73, 0x70, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x12, 0x1f, 0x0a,
	0x0b, 0x72, 0x61, 0x77, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x0c, 0x52, 0x0a, 0x72, 0x61, 0x77, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x42, 0x1e,
