...
type ApronServiceRequest struct {
	...
	ClientSchema []byte `protobuf:"bytes,4,opt,name=client_schema,json=clientSchema,proto3" json:"client_schema,omitempty"`
...
func (x *ApronServiceRequest) GetClientSchema() []byte {
	if x != nil {
...
type ApronServiceResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	RequestId   string `protobuf:"bytes,2,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`
	RawResponse []byte `protobuf:"bytes,10,opt,name=raw_response,json=rawResponse,proto3" json:"raw_response,omitempty"`
}

func (x *ApronServiceResponse) Reset() {
	*x = ApronServiceResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ApronServiceResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ApronServiceResponse) ProtoMessage() {}

func (x *ApronServiceResponse) ProtoReflect() protoreflect.Message {
	mi := &file_models_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ApronServiceResponse.ProtoReflect.Descriptor instead.
func (*ApronServiceResponse) Descriptor() ([]byte, []int) {
	return file_models_proto_rawDescGZIP(), []int{6}
}

func (x *ApronServiceResponse) GetPeerId() string {
	if x != nil {
		return x.PeerId
	}
	return ""
...
func (x *ApronServiceResponse) GetRequestId() string {
	if x != nil {
		return x.RequestId
	}
	return ""
...
func (x *ApronServiceResponse) GetRawResponse() []byte {
	if x != nil {
...
var file_models_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x50, 0x61, 0x74, 0x68, 0x22, 0xb2, 0x01, 0x0a, 0x13, 0x41, 0x70, 0x72, 0x6f, 0x6e,
	...
	0x65, 0x65, 0x72, 0x49, 0x64, 0x12, 0x23, 0x0a, 0x0d, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x5f,
	0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0c, 0x63, 0x6c,
	0x69, 0x65, 0x6e, 0x74, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x12, 0x1f, 0x0a, 0x0b, 0x72, 0x61,
	0x77, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0c, 0x52,
	0x0a, 0x72, 0x61, 0x77, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x71, 0x0a, 0x14, 0x41,
	0x70, 0x72, 0x6f, 0x6e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	0x61, 0x77, 0x5f, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28,
	0x0c, 0x52, 0x0b, 0x72, 0x61, 0x77, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x1e,
	0x5a, 0x1c, 0x61, 0x70, 0x72, 0x6f, 0x6e, 0x2e, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x2f,
	0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x73, 0x62, 0x06,
...
var file_models_proto_goTypes = []interface{}{
	...
	(*ApronServiceResponse)(nil), // 6: ApronServiceResponse
}
...
func file_models_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_models_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ApronServiceResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
